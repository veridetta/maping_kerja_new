...
?>
<head>
  <title>Proses Data K-Means PKH</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
  <a class="navbar-brand" href="prosesdatakmeanspkh.php">PROSES DATA K-MEANS PKH</a>
        ...
        <div class="card-body">
            <div class="col-12">
                <table
                    ...
                    data-url="get_prosesdatakmeanspkh.php"
...
function initMap() {};
 ...
 function operasi(value,row,index){
   return[
     '<a href="datakmeanspkh.php" class="btn btn-warning">Kembali</a>'
   ].join('')
 }
