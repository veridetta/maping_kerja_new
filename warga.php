...
$dat_jum_menengah=mysqli_query($connect, "select * from datawarga where penghasilan BETWEEN 1200001 AND 1800000");
$dat_jum_mampu=mysqli_query($connect, "select * from datawarga where penghasilan > 1800001");
...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
  <a class="navbar-brand" href="warga.php">Cluster Warga</a>
...
<div class="container" style="padding-top:25px; padding-bottom:25px;">
  <div>
    <h3 class="text-center" style="padding-bottom:25px;">CLUSTER WARGA</h3>
    <hr>
  </div>  
  <div class="col-12 row">
    <div class="col-12">
        <a href="warga.php?filter=1&&min=0&max=1200000"><span class="h4 badge <?php if($filter==1){echo 'badge-success';}else{ echo 'badge-primary';}?>" id="kurang_mampu">Kurang Mampu</span></a>
        <a href="warga.php?filter=2&&min=1200001&max=1800000"><span class="h4 badge <?php if($filter==2){echo 'badge-success';}else{ echo 'badge-primary';}?>" id="menengah">Menengah</span></a>
        <a href="warga.php?filter=3&&min=1800001&max=1200000000"><span class="h4 badge <?php if($filter==3){echo 'badge-success';}else{ echo 'badge-primary';}?>" id="Mampu">Mampu</span></a>
        <a href="warga.php"><span class="h4 badge <?php if($filter==''){echo 'badge-success';}else{ echo 'badge-primary';}?>" id="semua">Semua</span></a>
      </div>
    <div class="col-9">
    ...
    <div class="card">
      <div class="card-header">Statistik</div>
        <div class="card-body">
          <p class=""><i class="fas fa-user"></i> Tidak Mampu : <span class="h4 badge badge-danger" id="semua"><?php echo $jum_tidak_mampu;?> Orang</span></p>
          <p class=""><i class="fas fa-user"></i> Menengah : <span class="h4 badge badge-warning" id="semua"><?php echo $jum_menengah;?> Orang</span></p>
