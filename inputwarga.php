...
error_reporting(error_reporting() & ~E_NOTICE);
    ...
    $ittl=isset($ambil['ttl']) ? $ambil['ttl'] : '';
    if($_SESSION){
        if($_GET){
            if($iid){
                ...
                while($ambil=mysqli_fetch_array($select)){
                    ...
                    $ittl=isset($ambil['ttl']) ? $ambil['ttl'] : '';
                    $inohp=$ambil['hp'];
                    $ipenghasilan=$ambil['penghasilan'];
...
<div class="container" style="padding-top:25px; padding-bottom:25px;">
    <div class="row col-12 justify-content-center">
        <div class="col-11 col-lg-11 col-xs-12 col-md-11 col-sm-11 col-xl-11">
            ...
            ?>
            <p class="h3"><?php if($id!=""){echo "Edit Data Warga";}else{echo "Input Data Warga";};?></p>
            <hr>
            <div class="card">
                <div class="card-header">
                <?php if($id!=""){echo "Edit Data";}else{echo "Input Data Baru";};?>
                </div>
                <div class="card-body">
                    ...
                    <div class="col-12 row justify-content-center">
                        <div class="col-lg-6 col-xl-6 col-md-6 col-xs-12 col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <input required placeholder="Tempat, Tanggal Lahir" value="<?php echo $ittl;?>" type="text" id="ttl" name="ttl" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                ...
                                <input required placeholder="Penghasilan Perbulan" value="<?php echo $ipenghasilan;?>" type="number" id="penghasilan" name="penghasilan" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
