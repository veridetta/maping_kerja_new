...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
  <a class="navbar-brand" href="datakmeanspkh.php">DATA K-MEANS PKH</a>
            ...
            $remove=isset($_POST['remove']) ? $_POST['remove'] : '';
             if($role=="admin"){
              if($remove){
                ...
                $hapus=mysqli_query($connect, "DELETE from datakmeanspkh where id='$idremovee'");
                if($hapus){
        ...
        <div class="card-body">
            <div class="col-12">
                <table
                    ...
                    data-url="get_datakmeanspkh.php"
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form method="post" action="datakmeanspkh.php"><input type="hidden" name="idremove" id="idremove" value="">
...
function initMap() {};
 ...
 function operasi(value,row,index){
   return[
     '<a href="prosesdatakmeanspkh.php" class="btn btn-warning">Proses</a>'
   ].join('')
 }
  ...
  window.operateEvents = {
    'click .edit': function (e, value, row, index) {
      ...
      location.href = "inputkmeanspkh.php?id="+replacer(jsson);
  ...
  function editData(id){
    var url = "inputkmeanspkh.php?id="+id;
    windows.open(url);
  }
